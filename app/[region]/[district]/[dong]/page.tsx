...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const seedString = locationTitle + districtName + dongName + "tagtherest-dong-mashup";
  ...
  const finalTitle = `${locationTitle} ${selectedModifier} ${selectedService} 안내 · 태그더레스트`;
