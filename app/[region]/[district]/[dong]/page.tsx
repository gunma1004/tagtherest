...
// 네이버 로봇 및 검색엔진이 수집하는 고유 메타데이터 생성 (20개 고유 배리에이션 - 마사지 포함, 출장 배제)
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const titleVariants = [
    `${locationTitle} 마사지 24시 제휴 안내 및 추천 스팟 | 태그더레스트`,
    `${simpleLocation} 프리미엄 마사지 프로그램 및 정찰제 요금 정보 · 태그더레스트`,
    `${locationTitle} 전문 아로마 및 스웨디시 마사지 힐링 가이드 - 태그더레스트`,
    `${simpleLocation} 일상 속 휴식을 선사하는 정통 마사지 공간 | 태그더레스트`,
    `${locationTitle} 베테랑 힐러와 함께하는 전신 마사지 제휴점 - 태그더레스트`,
    `${simpleLocation} 웰니스 바디케어 및 프리미엄 마사지 코스 안내 · 태그더레스트`,
    `${locationTitle} 1:1 맞춤형 릴렉스 마사지 프로그램 큐레이션 - 태그더레스트`,
    `${simpleLocation} 신뢰할 수 있는 마사지 제휴업체 정보 및 이용 가이드 | 태그더레스트`,
    `${locationTitle} 쾌적한 감성 마사지 및 아로마 테라피 정보 - 태그더레스트`,
    `${simpleLocation} 피로회복을 위한 맞춤형 마사지 코스 및 요금 · 태그더레스트`,
    `${locationTitle} 전문 테라피스트 마사지 제휴 샵 리스트 - 태그더레스트`,
    `${simpleLocation} 편안한 안식을 위한 바디케어 및 마사지 안내 - 태그더레스트`,
    `${locationTitle} 감성 릴렉싱 및 스웨디시 마사지 프로그램 요약 - 태그더레스트`,
    `${simpleLocation} 도심 속 프라이빗 힐링 마사지 전문 스팟 안내 - 태그더레스트`,
    `${locationTitle} 맞춤형 바디 테라피 및 마사지 제휴 정보 - 태그더레스트`,
    `${simpleLocation} 쾌적하고 조용한 마사지 샵 이용 가이드 - 태그더레스트`,
    `${locationTitle} 프리미엄 컨디션 케어 및 마사지 프로그램 안내 - 태그더레스트`,
    `${simpleLocation} 일상 회복을 위한 바디 릴렉싱 마사지 코스 - 태그더레스트`,
    `${locationTitle} 정통 테라피 및 감성 마사지 제휴 가이드 - 태그더레스트`,
